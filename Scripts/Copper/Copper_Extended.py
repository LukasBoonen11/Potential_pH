...
dG_Chloride_Species = np.array((-131.2, -119.9, -240.1, -376, -68.2, -175.7))          # Thermodynamic data - (0) Cl-, (1) CuCl, (2) CuCl2-, (3) CuCl32-, (4) CUCl+, (5) CuCl2
...
dG_Reaction_9_Grid = ((dG_Cl_Grid_1 + dG_Electron_Grid) - (dG_Cu_Grid_0 + dG_Cl_Grid_0))

### Reaction 10 - CuCl2-

dG_Reaction_10_Grid = ((dG_Cl_Grid_2 + dG_Electron_Grid) - (dG_Cu_Grid_0 + (2 * dG_Cl_Grid_0)))

### Reaction 11 - CuCl32-

dG_Reaction_11_Grid = ((dG_Cl_Grid_3 + dG_Electron_Grid) - (dG_Cu_Grid_0 + (3 * dG_Cl_Grid_0)))

### Reaction 12 - CuCl+

dG_Reaction_12_Grid = ((dG_Cl_Grid_4 + (2 * dG_Electron_Grid)) - (dG_Cu_Grid_0 + dG_Cl_Grid_0))

### Reaction 13 - CuCl2

dG_Reaction_13_Grid = ((dG_Cl_Grid_5 + (2 * dG_Electron_Grid)) - (dG_Cu_Grid_0 + (2 * dG_Cl_Grid_0)))

### Reaction 14 - CuSO4

dG_Reaction_14_Grid = ((dG_SO4_Grid_2 + (2 * dG_Electron_Grid)) - (dG_Cu_Grid_0 + dG_SO4_Grid_0))

### Reaction 15 - CuSO4.3Cu(OH)2

dG_Reaction_15_Grid = (((1/4 * dG_SO4_Grid_3) + (3/2 * dG_Proton_Grid) + (2 * dG_Electron_Grid)) - (dG_Cu_Grid_0 + (1/4 * dG_SO4_Grid_0) + (3/2 * dG_H2O_Grid)))

### Reaction 16 - CuSO4.2Cu(OH)2

dG_Reaction_16_Grid = (((1/3 * dG_SO4_Grid_4) + (4/3 * dG_Proton_Grid) + (2 * dG_Electron_Grid)) - (dG_Cu_Grid_0 + (1/3 * dG_SO4_Grid_0) + (4/3 * dG_H2O_Grid)))

### Reaction 17 - CuCO3.Cu(OH)2

dG_Reaction_17_Grid = (((1/2 * dG_CO3_Grid_2) + dG_Proton_Grid + (2 * dG_Electron_Grid)) - (dG_Cu_Grid_0 + (1/2 * dG_CO3_Grid_0) + dG_H2O_Grid))

### Reaction 18 - 2CuCO3.Cu(OH)2

dG_Reaction_18_Grid = (((1/3 * dG_CO3_Grid_3) + (2/3 * dG_Proton_Grid) + (2 * dG_Electron_Grid)) - (dG_Cu_Grid_0 + (2/3 * dG_CO3_Grid_0) + (2/3 * dG_H2O_Grid)))
...
np.savetxt(r'C:\\Users\\lukas.boonen\\OneDrive - Proviron Holding nv\\Desktop\\Research Papers\\Paper 1\\E_pH\\E_pH_Cu_V.csv', dG_Pourbaix_Diagram, delimiter = ';', comments='')
...
def Plot_Pourbaix_Diagram():
    ...
    ax1.plot(np.linspace(6.0, 6.5, 100), np.repeat(1.70, 100), '-', color = '#141414')
    ...
    plt.text(8.35, 1.00, r'CuO$_{(s)}$', fontsize = 9)
    plt.text(9.75, 1.70, r'HCuO$_{2 (aq)}^{-}$', fontsize = 9)
    plt.text(13.25, -0.05, r'CuO$_{2 (aq)}^{2-}$', fontsize = 9)

    plt.text(3.00, 0.10, r'CuCl$_{2 (aq)}^{-}$', fontsize = 9)
    plt.text(2.50, 0.75, r'CuCl$_{(aq)}^{+}$', fontsize = 9)

    plt.text(0.55, 1.70, r'CuCO$_{3}$.Cu(OH)$_{2 (s)}$', fontsize = 9)
...
Export_Plot(fig_Pourbaix_Diagram, r'C:\\Users\\lukas.boonen\\OneDrive - Proviron Holding nv\\Desktop\\Research Papers\\Paper 1\\E_pH\\E_pH_Cu_V', 1200)
