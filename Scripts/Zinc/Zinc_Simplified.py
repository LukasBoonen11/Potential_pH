...
np.savetxt(r'C:\\Users\\lukas.boonen\\OneDrive - Proviron Holding nv\\Desktop\\Research Papers\\Paper 1\\E_pH\\E_pH_Zn_I.csv', dG_Pourbaix_Diagram, delimiter = ';', comments='')
...
def Plot_Pourbaix_Diagram():
    ...
    plt.text(1.50, 1.50, r'Zn$_{(aq)}^{2+}$', fontsize = 10)
    plt.text(8.95, 1.50, r'ZnO$_{(s)}$', fontsize = 10)
...
Export_Plot(fig_Pourbaix_Diagram, r'C:\\Users\\lukas.boonen\\OneDrive - Proviron Holding nv\\Desktop\\Research Papers\\Paper 1\\E_pH\\E_pH_Zn_I', 1200)
